...
Conjecture \ref{gauss-circle-conj} is known to hold for $k \ge 4$, i.e.
...
In light of Conjecture \ref{gauss-circle-conj} and \Cref{gauss-circle-lower-23}, in the rest of this section we shall focus on upper bounds on $\theta^{\operatorname{Gauss}}_{k}$ for $k = 2, 3$.
