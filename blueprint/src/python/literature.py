...
def add_bourgain_large_values_estimate():
    polys = [
        ...
        Polytope.rect(
            ...
            (frac(0), frac(1)),                         # 0 <= τ <= 1
            (frac(0), Constants.LV_DEFAULT_UPPER_BOUND) # 0 <= ρ
        ),
        Polytope([
            [frac(16,3), -frac(20,3), frac(1,3), -1],   # ρ <= 16/3 - 20/3σ + τ/3
            [0, 0, 0, 1],               # ρ >= 0
            [10, -14, 1, 0],            # 10 - 14σ + τ >= 0
            [-1, 0, 1, 0],              # τ >= 1
            [4, 4, -5, 0],              # 4/5 + 4/5σ - τ >= 0
            [-11, 16, -1, 0]            # τ <= 16σ - 11
        ]),
        Polytope([
            [5, -7, frac(3,4), -1],     # ρ <= 5 - 7σ + 3τ/4
            [0, 0, 0, 1],               # ρ >= 0
            [8, -8, -1, 0],             # τ <= 8 - 8σ
            [-16, 20, frac(1,3), 0],    # τ >= 3(20σ - 16)
            [-6, 10, -frac(7,6), 0],    # -6 + 10σ - 7τ/6 >= 0
            [-4, -4, 5, 0]              # -4 - 4σ + 5τ >= 0
        ]),
        Polytope([
            [3, -5, 1, -1],             # ρ <= 3 - 5σ + τ
