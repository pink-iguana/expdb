...
`huxley-table`). -/
theorem huxleyTables_valid (b : AffineBetaBound)
    (hb : b ∈ huxleyTable17_1 ∨ b ∈ huxleyTable19_2) : b.IsValid := by
  sorry
...
`combined-bound`). -/
theorem combinedBetaBounds_valid (b : AffineBetaBound)
    (hb : b ∈ combinedBetaBounds) : b.IsValid := by
  sorry
