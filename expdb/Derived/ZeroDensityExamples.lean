...
theorem carlson_at_3_4 : IsZeroDensityBound 3 (3/4) :=
  by
    convert carlson_zero_density (3/4) (by norm_num) (by norm_num) using 1; norm_num
...
theorem carlson_at_1_2 : IsZeroDensityBound 2 (1/2) :=
  by
    convert carlson_zero_density (1/2) (by norm_num) (by norm_num) using 1; norm_num
...
theorem ingham_at_3_4 : IsZeroDensityBound (12/5) (3/4) :=
  by
    convert ingham_zero_density (3/4) (by norm_num) (by norm_num) (by norm_num) using 1;
      norm_num
...
theorem ingham_at_1_2 : IsZeroDensityBound 2 (1/2) :=
  by
    convert ingham_zero_density (1/2) (by norm_num) (by norm_num) (by norm_num) using 1;
      norm_num
...
theorem heathbrown_at_15_16 : IsZeroDensityBound (16/11) (15/16) :=
  by
    convert heathbrown_zero_density (15/16) (by norm_num) (by norm_num) using 1; norm_num
...
theorem guth_maynard_at_1_2 : IsZeroDensityBound (30/11) (1/2) :=
  by
    convert guth_maynard_zero_density (1/2) (by norm_num) (by norm_num) using 1; norm_num
...
theorem guth_maynard_at_3_4 : IsZeroDensityBound (20/9) (3/4) :=
  by
    convert guth_maynard_zero_density (3/4) (by norm_num) (by norm_num) using 1; norm_num
